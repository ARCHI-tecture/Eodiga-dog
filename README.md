...
어디가개는 한국문화정보원의 전국 반려동물 동반 가능 문화시설 위치 데이터 api를 활용한 반려견 동반 가능 시설 모음 지도 웹앱입니다.
...
| 내 리뷰 - 데스크탑 화면 |     ![내 리뷰 화면](https://github.com/user-attachments/assets/573b708e-3b3b-49d2-9e02-98806b46b283)      |
| :---------------------: | :-------------------------------------------------------------------------------------------------------: |
|  내 리뷰 - 모바일 화면  | <img src="https://github.com/user-attachments/assets/749f123d-d221-4f5a-9642-1a348278b463" height="442"/> |
...
|                               🐰**이가영**                               |                            🐣**노효민**                             |                            🐼**손예림**                             |                                  🐹**조다솜**                                  |
| :----------------------------------------------------------------------: | :-----------------------------------------------------------------: | :-----------------------------------------------------------------: | :----------------------------------------------------------------------------: |
| <img src="https://i.ibb.co/3rKpSsS/3x4-event2.jpg" height=200 width=180> | <img src="https://i.ibb.co/Hd9Pz5B/image.jpg" height=220 width=180> | <img src="https://i.ibb.co/DpmsYD3/image.png" height=220 width=180> | <img src="https://i.ibb.co/L0wswBF/removebg-preview.png" height=220 width=180> |
...
- 검색 결과 클릭 시 해당 시설의 상세 정보 페이지가 출력되지 않는 오류가 발생해 담당 중이던 팀원에게서 해당 오류를 넘겨받음
- 처음에는 상세 정보 페이지의 문제라 생각해 상세 정보 페이지를 수정해 보았으나 해결 실패
- 해당 컴포넌트를 호출하는 부모 컴포넌트를 확인해 보니 `props`로 전달되는 `selectedItem`에서 문제 발견
- 사용하는 API의 JSON 데이터는 `key`값이 한글임 (예: "시설명", "카테고리1", "카테고리2" ... )
- `selectedItem`은 JSON 데이터 전체를 보내 좌표값이 `"위도"`, `"경도"`에 있는데 상세 정보 페이지는 좌표값을 `lat`과 `lng`으로 처리하고 있었음

#### - 해결

- JSON 데이터에서 `"위도"`와 `"경도"`값만 추출
- 새로운 객체 `coordinates`의 `lat`과 `lng`에 `"위도"`와 `"경도"`값을 할당
- `selectedItem`을 `coordinates`로 설정하여 `props`로 전달함
...
| 🐰**이가영**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| React의 대표적 프레임워크인 Next.js를 공부하고, 학습에 열정적인 팀원들과 함께 하게 되어 기뻤습니다. 무엇보다 Next.js의 직관적인 라우팅 구조가 흥미로웠습니다. 그 덕분에 프론트엔드와 백엔드의 엔드포인트를 통합하여 편리하게 개발할 수 있었습니다. 특히, API로 좌표 데이터를 받아와 지도와 연동하는 작업이 인상깊었고, 그 과정에서 여러 API를 조합해 새로운 기능을 구현하는 경험을 할 수 있어 좋았습니다. 덕분에 이후로 기업들의 Open API를 볼 때마다 어떻게 조합해서 어떤 기능을 개발하면 좋을지 생각하게 된 것 같습니다. 느린 API 응답 속도를 단축하지 못한 점이 아쉬운 경험으로 남았습니다만, 이를 계기로 성능 최적화에 대해 관심을 가지게 되었습니다. 프론트엔드 개발자로서 나아가야 할 방향을 체득할 수 있었던 좋은 경험이었습니다.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| 🐣**노효민**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
